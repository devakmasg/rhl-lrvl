...
@php
  // Every single-number spot on the site reads the primary; the Contact column
  // below is one of only two places that can list more than one.
...
<footer>
  <div class="footer-top">
    ...
    <div>
      ...
      @include('partials.contact-numbers', ['numbers' => $contactNumbers->isNotEmpty() ? $contactNumbers : collect([$primaryNumber])])
...
<div class="float-actions">
  <a href="tel:{{ $primaryNumber->tel }}" class="float-btn float-call" aria-label="Call {{ \App\Support\Brand::shortName() }}">
