{{-- Frozen footer markup (see hsc TASKS.md F0.4) — keep byte-identical to the
     Phase 1 static source other than href → route() conversions. --}}
<footer>
  <div class="footer-top">
    <div class="footer-brand">
      <span class="word">RHL Properties Ltd</span>
      <p>A diversified real estate and investment group building landmark residential, commercial and hospitality developments since 1998.</p>
    </div>
    <div>
      <h4>Contact</h4>
      <a href="tel:+8801711234567">+880 1711-234567</a>
      <a href="mailto:hello@rhlproperties.com.bd">hello@rhlproperties.com.bd</a>
      <p>House 24, Road 11, Gulshan-1,<br>Dhaka 1212, Bangladesh</p>
    </div>
    <div>
      <h4>Explore</h4>
  ...
  <div class="footer-bottom">
    <span>&copy; {{ date('Y') }} RHL Properties Ltd. All Rights Reserved.</span>
    <span>Concept design template</span>
  </div>
</footer>

<div class="float-actions">
  <a href="tel:+8801711234567" class="float-btn float-call" aria-label="Call RHL Properties">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.362 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.338 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
  </a>
  <a href="https://wa.me/8801711234567" class="float-btn float-whatsapp" aria-label="Chat with us on WhatsApp" target="_blank" rel="noopener">
